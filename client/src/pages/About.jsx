...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      <h1 className='text-3xl font-bold mb-4 text-slate-800'>About Stefan Estate</h1>
      <p className='mb-4 text-slate-700'>
        Stefan Estate is a leading real estate agency that specializes in helping
        ...
        as possible. Our mission is to help our clients achieve their real
